...
// @desc Update an existing product in the database by ID
// @access Private/Admin
...
// @desc Delete a product in the database by ID
// @access Private/Admin
...
router.get("/", async (req, res) => {
  try {
    ...
    // Fetch products from DB and then apply sorting and limit
...
// @desc Retrieve the lates 8 products - Creation date
// @access Public

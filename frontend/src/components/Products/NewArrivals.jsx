...
const NewArrivals = () => {
  ...
  const scroll = (direction) => {
    ...
    if (scrollRef.current) {
      ...
      // Run update after a slight delay to allow smooth scroll to settle
  ...
  return (
    <section className="py-16 px-4 lg:px-0">
      <div className="container mx-auto text-center mb-4 relative">
        <h2 className="text-3xl font-bold mb-4">Explore New Arrivals</h2>
        <p className="text-lg text-gray-600 mb-2">
          Discover the latest styles straight off the runway, freshly added to
          keep your wadrobe on the cutting edge of fashion.
        </p>
      ...
      <div
        ref={scrollRef}
        className={`
          container mx-auto overflow-x-auto flex space-x-6 relative pb-1
